...
def can_be_created_with_a_hash_of_attributes
  ...
  new_movie = Movie.new
  new_movie.title = attributes[:title]
  new_movie.release_date = attributes[:release_date]
  new_movie.director = attributes[:director]
  new_movie.lead = attributes[:lead]
  new_movie.in_theaters = attributes[:in_theaters]
  new_movie.save
  new_movie
end

def can_be_created_in_a_block(args = {release_date: 1990, title: "Home Alone"})
